...
def upgrade() -> None:
    ...
    op.create_table(
        "mst_ceisa_reference_jenis_transaksi_perdagangan",
    ...
    op.create_index(
        "ix_mst_ceisa_reference_jenis_transaksi_perdagangan_is_active",
        "mst_ceisa_reference_jenis_transaksi_perdagangan",
        ["is_active"],
        unique=False,
    )
    ...
    now = datetime.utcnow()
    seed_rows = [{**row, "last_synced_at": now, "created_at": now} for row in CEISA_REFERENCE_JENIS_TRANSAKSI_PERDAGANGAN_CODES]
    op.bulk_insert(table, seed_rows)


def downgrade() -> None:
    """Drop table mst_ceisa_reference_jenis_transaksi_perdagangan."""
    op.drop_index("ix_mst_ceisa_reference_jenis_transaksi_perdagangan_is_active", table_name="mst_ceisa_reference_jenis_transaksi_perdagangan")
    op.drop_index("ix_mst_ceisa_reference_jenis_transaksi_perdagangan_code", table_name="mst_ceisa_reference_jenis_transaksi_perdagangan")
    op.drop_index("ix_mst_ceisa_reference_jenis_transaksi_perdagangan_reference_slug", table_name="mst_ceisa_reference_jenis_transaksi_perdagangan")
    op.drop_table("mst_ceisa_reference_jenis_transaksi_perdagangan")
