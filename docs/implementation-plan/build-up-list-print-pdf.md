...
>
> - File layout print menggunakan CSS Paper A4 berbasis [a4.html](/materialize-fastapi/app/templates/paper-css/examples/a4.html) yang digabungkan secara inline dengan struktur tabel dari [pdf_build_up.html](/materialize-fastapi/app/templates/pdf_build_up.html).
> - File cetakan baru akan dibuat di [build_up_print_pdf.html](/materialize-fastapi/app/templates/build_up_print_pdf.html).
...
#### [MODIFY] [build_up_check_repository.py](/materialize-fastapi/app/repositories/build_up_check_repository.py)
...
#### [MODIFY] [build_up_check_service.py](/materialize-fastapi/app/services/build_up_check_service.py)
...
- Menambahkan method `generate_build_up_pdf(self, header_id: int, is_checklist: bool) -> bytes` untuk:
  ...
  - Memetakan data database ke dalam objek model/dict `manifest` yang memiliki struktur variabel yang sama persis seperti yang dibutuhkan oleh template [pdf_build_up.html](/materialize-fastapi/app/templates/pdf_build_up.html).
  - Melakukan parser pada string ULD (misal `AKE12345FX`) untuk memecah menjadi `uld_type`, `uld_number`, dan `uld_owner`.
  - Melakukan rendering template baru [build_up_print_pdf.html](/materialize-fastapi/app/templates/build_up_print_pdf.html) menggunakan Jinja2.
  - Mengompilasi HTML tersebut menjadi binary PDF menggunakan `xhtml2pdf` (`pisa.CreatePDF`).

#### [MODIFY] [build_up_check.py](/materialize-fastapi/app/api/build_up_check.py)
...
#### [MODIFY] [routes.py](/materialize-fastapi/app/api/routes.py)

- Meregistrasikan `build_up_check.pdf_router` ke dalam route utama agar bisa diakses.

#### [NEW] [build_up_print_pdf.html](/materialize-fastapi/app/templates/build_up_print_pdf.html)
...
#### [NEW] [warehouse.js](/astro/src/lib/api/warehouse.js)

- File pemanggil API untuk Datatables Build Up List.

#### [NEW] [BuildUpListDatatables.jsx](/astro/src/components/react/warehouse/BuildUpListDatatables.jsx)
...
#### [NEW] [build-up-list.astro](/astro/src/pages/warehouse/build-up-list.astro)
