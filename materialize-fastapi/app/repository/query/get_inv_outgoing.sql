...
FROM `out_invoiceheader` a 
LEFT JOIN out_invoicedetail b   ON a.InvoiceNumber = b.InvoiceNumber
LEFT JOIN out_weighingdetail c  ON b.ProofNumber   = c.ProofNumber
LEFT JOIN eks_masterwaybill d   ON b.MasterAWB     = d.MasterAWB
LEFT JOIN mst_customer e        ON a.CustomerCode  = e.CustomerCode
LEFT JOIN out_weighingheader f  ON b.ProofNumber   = f.ProofNumber
