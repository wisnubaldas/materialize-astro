...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_mst_ceisa_reference_komoditi_cukai_reference_slug",
        "mst_ceisa_reference_komoditi_cukai",
        ["reference_slug"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_mst_ceisa_reference_komoditi_cukai_is_active",
        "mst_ceisa_reference_komoditi_cukai",
        ["is_active"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index("ix_mst_ceisa_reference_komoditi_cukai_is_active", table_name="mst_ceisa_reference_komoditi_cukai")
    op.drop_index("ix_mst_ceisa_reference_komoditi_cukai_code", table_name="mst_ceisa_reference_komoditi_cukai")
    op.drop_index("ix_mst_ceisa_reference_komoditi_cukai_reference_slug", table_name="mst_ceisa_reference_komoditi_cukai")
