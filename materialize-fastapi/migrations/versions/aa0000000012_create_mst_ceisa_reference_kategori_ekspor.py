...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_mst_ceisa_reference_kategori_ekspor_rslug",
        "mst_ceisa_reference_kategori_ekspor",
        ["reference_slug"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_mst_ceisa_reference_kategori_ekspor_active",
        "mst_ceisa_reference_kategori_ekspor",
        ["is_active"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index("ix_mst_ceisa_reference_kategori_ekspor_active", table_name="mst_ceisa_reference_kategori_ekspor")
    op.drop_index("ix_mst_ceisa_reference_kategori_ekspor_code", table_name="mst_ceisa_reference_kategori_ekspor")
    op.drop_index("ix_mst_ceisa_reference_kategori_ekspor_rslug", table_name="mst_ceisa_reference_kategori_ekspor")
