    ...
    if (this._horizontal) {
      ...
      this._evntBodyClick = (e) => {
        if (
          ...
          this._el.querySelectorAll(".menu-inner > .menu-item.open").length
        )
          this.closeAll();
      };
      ...
      if (this._showDropdownOnHover) {
        ...
        this._evntElMouseOut = (e) => {
          ...
          if (
            ...
            mouseOutEl.closest("ul").classList.contains("menu-inner")
          ) {
          ...
          if (
            ...
            if (
              this._topParent &&
              !Menu.childOf(mouseOverEl, this._topParent.parentNode)
            ) {
              const toggleLink = this._topParent.classList.contains(
                "menu-toggle"
              )
                ? this._topParent
                : null;
            ...
            const toggleLink = mouseOutEl.classList.contains("menu-toggle")
              ? mouseOutEl
              : null;
