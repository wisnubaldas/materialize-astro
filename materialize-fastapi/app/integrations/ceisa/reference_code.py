...
from app.integrations.ceisa.mapper import CeisaPayloadMapper
...
class CeisaReferenceCodeService:
    ...
    def extract_reference_rows(
        ...
        rows = CeisaPayloadMapper.extract_reference_rows(
            payload=payload,
            code_keys=code_keys,
            name_keys=name_keys,
        )
    ...
    def _extract_candidate_rows(payload: Any) -> list[dict[str, Any]]:
        ...
        return CeisaPayloadMapper.extract_candidate_rows(payload)
    ...
    def _pick_first_value(row: dict[str, Any], keys: list[str]) -> str | None:
        ...
        return CeisaPayloadMapper.pick_first_value(row=row, keys=keys)
