...
#### [MODIFY] [setting.py](file:///c:/Users/wisnu/Documents/Belajar/materialize-project/materialize-fastapi/app/api/setting.py)
...
#### [MODIFY] [sse.py](file:///c:/Users/wisnu/Documents/Belajar/materialize-project/materialize-fastapi/app/api/sse.py)
- Hapus route `log_app`, fungsi pembantu `__log_event_stream()`, dan variabel `LOG_PATH`.

#### [MODIFY] [auth_middleware.py](file:///c:/Users/wisnu/Documents/Belajar/materialize-project/materialize-fastapi/app/api/middleware/auth_middleware.py)
...
#### [NEW] [logging.astro](file:///c:/Users/wisnu/Documents/Belajar/materialize-project/astro/src/pages/setting/logging.astro)
...
#### [DELETE] [logging.astro](file:///c:/Users/wisnu/Documents/Belajar/materialize-project/astro/src/pages/hub-net/logging.astro)
- Hapus halaman logging lama di bawah `/hub-net`.

#### [NEW] [SseDataTracking.jsx](file:///c:/Users/wisnu/Documents/Belajar/materialize-project/astro/src/components/react/setting/SseDataTracking.jsx)
...
#### [DELETE] [SseDataTracking.jsx](file:///c:/Users/wisnu/Documents/Belajar/materialize-project/astro/src/components/react/hubnet/SseDataTracking.jsx)
- Hapus komponen tersebut dari direktori komponen hubnet.

#### [MODIFY] [index.js](file:///c:/Users/wisnu/Documents/Belajar/materialize-project/astro/src/components/react/setting/index.js)
- Ekspor `SseDataTracking` dari file index setting.

#### [MODIFY] [index.js](file:///c:/Users/wisnu/Documents/Belajar/materialize-project/astro/src/components/react/hubnet/index.js)
- Hapus ekspor `SseDataTracking` dari file index hubnet.

#### [MODIFY] [sse.js](file:///c:/Users/wisnu/Documents/Belajar/materialize-project/astro/src/lib/api/sse.js)
