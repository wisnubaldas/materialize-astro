...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_mst_ceisa_reference_jenis_impor_reference_slug",
        "mst_ceisa_reference_jenis_impor",
        ["reference_slug"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_mst_ceisa_reference_jenis_impor_is_active",
        "mst_ceisa_reference_jenis_impor",
        ["is_active"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index("ix_mst_ceisa_reference_jenis_impor_is_active", table_name="mst_ceisa_reference_jenis_impor")
    op.drop_index("ix_mst_ceisa_reference_jenis_impor_code", table_name="mst_ceisa_reference_jenis_impor")
    op.drop_index("ix_mst_ceisa_reference_jenis_impor_reference_slug", table_name="mst_ceisa_reference_jenis_impor")
