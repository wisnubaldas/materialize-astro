...
def upgrade() -> None:
    ...
    op.create_table(
        "mst_ceisa_reference_satuan_barang",
    ...
    op.create_index(
        "ix_mst_ceisa_reference_satuan_barang_reference_slug",
        "mst_ceisa_reference_satuan_barang",
        ["reference_slug"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_mst_ceisa_reference_satuan_barang_is_active",
        "mst_ceisa_reference_satuan_barang",
        ["is_active"],
        unique=False,
    )
    ...
    now = datetime.utcnow()
    seed_rows = [{**row, "last_synced_at": now, "created_at": now} for row in CEISA_REFERENCE_SATUAN_BARANG_CODES]
    op.bulk_insert(table, seed_rows)


def downgrade() -> None:
    """Drop table mst_ceisa_reference_satuan_barang."""
    op.drop_index("ix_mst_ceisa_reference_satuan_barang_is_active", table_name="mst_ceisa_reference_satuan_barang")
    op.drop_index("ix_mst_ceisa_reference_satuan_barang_code", table_name="mst_ceisa_reference_satuan_barang")
    op.drop_index("ix_mst_ceisa_reference_satuan_barang_reference_slug", table_name="mst_ceisa_reference_satuan_barang")
    op.drop_table("mst_ceisa_reference_satuan_barang")
