  ...
  <div className="card p-md-7 p-1">
    <div className="app-brand justify-content-center mt-5">
      <a href="/" className="app-brand-link gap-2">
        ...
        <span className="app-brand-text demo text-heading fw-semibold">MAU APP</span>
      </a>
    </div>
    ...
    <div className="card-body mt-1">
      ...
      <form id="formAuthentication" className="mb-5" noValidate>
        <div id="login-error" className="alert alert-danger d-none" role="alert" aria-live="assertive">
        </div>
          ...
          <div className="form-password-toggle form-control-validation">
            <div className="input-group input-group-merge">
              ...
              <span className="input-group-text cursor-pointer">
                <i className="icon-base ri ri-eye-off-line icon-20px"></i>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-5">
          <button className="btn btn-primary d-grid w-100" id="login" type="submit">
            Sign in
          </button>
        </div>
      </form>
