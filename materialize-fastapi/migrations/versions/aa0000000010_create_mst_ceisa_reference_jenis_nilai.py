...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_mst_ceisa_reference_jenis_nilai_rslug",
        "mst_ceisa_reference_jenis_nilai",
        ["reference_slug"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_mst_ceisa_reference_jenis_nilai_active",
        "mst_ceisa_reference_jenis_nilai",
        ["is_active"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index("ix_mst_ceisa_reference_jenis_nilai_active", table_name="mst_ceisa_reference_jenis_nilai")
    op.drop_index("ix_mst_ceisa_reference_jenis_nilai_code", table_name="mst_ceisa_reference_jenis_nilai")
    op.drop_index("ix_mst_ceisa_reference_jenis_nilai_rslug", table_name="mst_ceisa_reference_jenis_nilai")
