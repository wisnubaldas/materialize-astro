...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  if (dt_customer_order) {
    ...
    var dt_order = new DataTable(dt_customer_order, {
      ...
      order: [[1, 'desc']],
      layout: {
        topStart: { rowClass: 'row card-header mx-0 px-2 py-0', features: [tableTitle] },
        topEnd: { search: { placeholder: 'Search order', text: '_INPUT_' } },
        bottomStart: { rowClass: 'row mx-2 justify-content-between', features: ['info'] },
        bottomEnd: 'paging'
      },
      displayLength: 6,
      language: {
