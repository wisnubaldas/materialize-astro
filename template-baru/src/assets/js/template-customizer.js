...
import { customizerMarkup } from './_template-customizer/_template-customizer.js';
import '@assets/libs/pickr/pickr';
...
class TemplateCustomizer {
  ...
  _setup(_container = document) {
    ...
    this._cleanup();
    this.container = document.getElementById('template-customizer'); // this._getElementFromString(customizerMarkup);
