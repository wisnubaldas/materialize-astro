"""repair build_up_check_header flight_no column

Revision ID: buc000000007
Revises: buc000000006
...
revision: str = "buc000000007"
down_revision: str | None = "buc000000006"
...
def upgrade() -> None:
    """Ensure Build Up header has the flight number column used by current models."""
...
def downgrade() -> None:
    """Keep flight_no during downgrade because older revisions also depend on it."""
    if not _table_exists(HEADER_TABLE):
        return
